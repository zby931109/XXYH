...
public class CarFullBean {
    ...
    private int maintIntervalDistance;
    ...
    public int getIs_turbo () {
        return is_turbo;
    }

    public void setIs_turbo (int is_turbo) {
    ...
    public int getMaintIntervalDistance () {
        return maintIntervalDistance;
    }

    public void setMaintIntervalDistance (int maintIntervalDistance) {
